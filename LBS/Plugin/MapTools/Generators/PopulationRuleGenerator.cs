...
namespace ISILab.LBS.Plugin.MapTools.Generators
{
    ...
    public class PopulationRuleGenerator : LBSGeneratorRule // FIX: Change to a better name
    {
        ...
        public override GeneratedGO Generate(LBSLayer layer, LBSGenerator3DSettings settings)
        {
            ...
            // Create pivot
            GameObject mainPivot = new GameObject("Population");
            ...
            for (int i = 0; i < layer.FloorCount; i++)
            {
                ...
                var go = GameObject.Instantiate(pref.obj);
                    ...
                    go.transform.position =
                        settings.position +
                        new Vector3(centerposition.x * scale.x, 0, centerposition.y * scale.z) +
                        -(new Vector3(scale.x, 0, scale.z) / 2f);
                ...
                GameObject parent = new GameObject("Floor " + i);
                ...
                // objects
                var x1 = objects.Keys.Average(o => o.transform.position.x);
                var y1 = objects.Keys.Min(o => o.transform.position.y);
                var z1 = objects.Keys.Average(o => o.transform.position.z);

                parent.transform.position = new Vector3(x1, y1, z1);
                ...
                // sub pivot
                parent.transform.position += settings.position + Vector3.up * i * settings.scale.y;
                subPivots.Add(parent);
            }
