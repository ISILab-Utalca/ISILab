...
namespace ISILab.AI.Grammar
{
    ...
    [SerializeField,Commons.Attributes.ReadOnlyIncludeChildren, InspectorName("Object to take")] private GrammarBundleGraph _Objecttotake;

        protected override void SetData(QuestNodeData data) 
        {
            _terminal = data.Terminal;
            _Objecttotake = data.Fields.Find(f => f.name == "Object to take") as GrammarBundleGraph;
