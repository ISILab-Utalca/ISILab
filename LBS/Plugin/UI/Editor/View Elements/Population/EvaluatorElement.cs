...
namespace ISILab.LBS.Plugin.UI.Editor.View_Elements.Population.EvaluatorElement
{
    ...
    public partial class EvaluatorElement : LBSComplexVisualElement
    {
        ...
        private void OpenEvaluatorConfig(ClickEvent evt)
        {
            ...
            // 2. Comparamos el t�tulo actual con el que queremos poner
            // Usamos la misma cadena exacta que definiste para el t�tulo
            ...
            if (existingWindow != null)
            {
                ...
                {
                    // Si el t�tulo es diferente, cerramos la ventana vieja
                    existingWindow.Close();
                }
                else
                {
                    // Si es el mismo, solo le damos foco y no hacemos nada m�s
