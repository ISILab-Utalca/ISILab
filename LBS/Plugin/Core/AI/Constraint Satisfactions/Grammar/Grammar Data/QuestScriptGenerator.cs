...
{
    /// <summary>
    /// After a grammar file uxml is read. All the existing terminal definitions are parsed and added to each <see cref="GrammarTerminal"/>. 
    /// Then for each terminal definition, a corresponding MonoBehaviour script is generated to be used as a <see cref="QuestTrigger"/> in the UnityScene.
    /// <see cref="MonoBehaviour"/>s are autogenerated to keep the same  <see cref="GrammarField"/>s as the terminal definition, and to be used as <see cref="QuestTrigger"/>s. 
    /// 
    /// </summary>
