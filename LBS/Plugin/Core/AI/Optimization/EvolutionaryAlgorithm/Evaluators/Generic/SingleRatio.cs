    ...
    public class SingleRatio : IContextualEvaluator, IConfigurableEvaluator, IRangedEvaluator
    {
        ...
        public float Evaluate(IOptimizable evaluable)
        {
            ...
            else
            {
                ...
                //float worstValue = currentRatio < targetRatio ? targetRatio - threshold : targetRatio + threshold;
                //fitness = Mathf.InverseLerp(worstValue, targetRatio, currentRatio);

                //float diff = Mathf.Abs(1 / targetRatio - 1 / currentRatio);
                //fitness = Mathf.InverseLerp(2, 0, diff); // Pocos valores posibles?
