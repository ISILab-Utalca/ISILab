...
public class NewAssistant : LBSAssistant, IAssistantThreaded
{
    ...
    public NewAssistant(string IconGuid, string name, Color colorTint) : base(IconGuid, name, colorTint)
    {
    ...
    {
        return new NewAssistant(IconGuid, Name, ColorTint);
    }
