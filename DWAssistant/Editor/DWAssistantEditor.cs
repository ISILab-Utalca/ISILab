...
namespace ISILab.LBS.VisualElements
{
    ...
    public class DWAssistantEditor : LBSCustomEditor, IToolProvider, IAssistantThreadedEditor
    {
        ...
        {
            var m = new DWAssistantManipulator();
            m.Execute += Execute;
            var t = new LBSTool(m);
            t.OnSelect += LBSInspectorPanel.ActivateAssistantTab;
            toolkit.ActivateTool(t, assistant.OwnerLayer, assistant);
        }
