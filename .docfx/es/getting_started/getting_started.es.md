...
![Layer Panel](/images/getting_started/layer_info_01.png)
...
- Map generation layer. [See Module-1A](../module_1a_layer/module_1a_layer.es.md) or [Module-1B](../module_1b_layer/module_1b_layer.es.md)
- Entities population layer. [See Module-2](../population_layer/population_layer.es.md)
- Quest design layer.


### 3D Generation

![3D Size panel](/images/getting_started/3DInfo_01.png)
