...
# Level Building Sideckick API Doc.
...
<div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%; margin-bottom: 24px;">
  <iframe 
    src="https://www.youtube.com/embed/smIRgKcAXoY?loop=1&playlist=smIRgKcAXoY" 
...
## License
>The license for this project is available in the [Unity Asset Store](https://assetstore.unity.com/packages/tools/level-design/level-building-sidekick-308621).
