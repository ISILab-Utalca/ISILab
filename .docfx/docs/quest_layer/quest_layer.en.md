...
![Preview Quests](/images/quest_layer/Step_3_Capture.png)
...
![Quest Creation Step](/images/quest_layer/Step_3_Layer.png)

When any Quest layer is selected, the following tools will be displayed.

![Imagen de la barra de Herramientas](/images/quest_layer/Step_1A_tool_data.png)
...
![Inspect](/images/quest_layer/Step_3_2_Inspect.png)

![alt text](/images/quest_layer/Step_3_0_NodeInspector.png)
...
![alt text](/images/quest_layer/Step_3_Selected_Layer.png)

### Quest options 

![alt text](/images/quest_layer/Step_3_Pallete.png)
